# Ingest real-time data with Eventstream in Fabric
...
2. In the **Eventhouse** pane, configure the following setup options.
    ...
    - **KQL Destination table:** Under the text box, select **Create new** (do *not* type directly into the text box — if you do, the **Save** button will remain greyed out).
...
## Step 8: Query the transformed data
